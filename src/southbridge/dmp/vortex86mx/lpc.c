...
static void vortex86mx_sb_read_resources(device_t dev)
{
	struct resource *res;
...
static struct device_operations vortex86mx_sb_lpc_ops = {
	.read_resources   = vortex86mx_sb_read_resources,
...
static const struct pci_driver lpc_driver __pci_driver = {
	.ops    = &vortex86mx_sb_lpc_ops,
	.vendor = PCI_VENDOR_ID_DMP,
	.device = PCI_DEVICE_ID_DMP_VORTEX86MX_SB,
};
